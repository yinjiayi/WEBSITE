    ...
    FullScreenMario.FullScreenMario.settings.ui = {
        ...
        "styleSheet": {
            ...
            "@font-face": {
                ...
                "src": [
                    "url('https://www.chiphell.com/error/Fonts/pressstart2p-webfont.eot')",
                    "url('https://www.chiphell.com/error/Fonts/pressstart2p-webfont.eot?#iefix') format('embedded-opentype')",
                    "url('https://www.chiphell.com/error/Fonts/pressstart2p-webfont.woff') format('woff')",
                    "url('https://www.chiphell.com/error/Fonts/pressstart2p-webfont.ttf') format('truetype')",
                    "url('https://www.chiphell.com/error/Fonts/pressstart2p-webfont.svg') format('svg')"
                ].join(", "),
                "font-weight": "normal",
                "font-style": "normal"
            }
