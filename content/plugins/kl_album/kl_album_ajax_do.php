...
if(isset($_POST['album']) && isset($_FILES['Filedata'])){
	...
	define('KL_UPLOADFILE_PATH', '../../../content/uploadpic/');
	define('KL_IMG_ATT_MAX_W',	180);//图片附件缩略图最大宽
	define('KL_IMG_ATT_MAX_H',	888);//图片附件缩略图最大高
