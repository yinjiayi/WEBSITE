...
<style type="text/css">
#gallery {padding: 10px;text-align:left; font-size:12px;height:100%;overflow:auto;margin:0px}
	...
	foreach ($kl_album_info as $key => $val){
		...
		switch ($val['restrict']){
			case 'public':
				...
				$kl_img_str = '<span><img id="album_public_img_'.$key.'" class="notfengmian" src="'.$coverPath.'" width="'.$photo_size['w'].'" height="'.$photo_size['h'].'" /></span><span style="display:none;"><img id="album_private_img_'.$key.'" class="notfengmian" src="../content/plugins/kl_album/images/only_me.jpg" /></span><span style="display:none;"><img id="album_protect_img_'.$key.'" class="notfengmian" src="'.$coverPath.'" width="'.$photo_size['w'].'" height="'.$photo_size['h'].'" /></span>';
				break;
			case 'private':
				...
				$kl_img_str = '<span style="display:none;"><img id="album_public_img_'.$key.'" class="notfengmian" src="'.$coverPath.'" width="'.$photo_size['w'].'" height="'.$photo_size['h'].'" /></span><span><img id="album_private_img_'.$key.'" class="notfengmian" src="../content/plugins/kl_album/images/only_me.jpg" /></span><span style="display:none;"><img id="album_protect_img_'.$key.'" class="notfengmian" src="'.$coverPath.'" width="'.$photo_size['w'].'" height="'.$photo_size['h'].'" /></span>';
				break;
			case 'protect':
				...
				$kl_img_str = '<span style="display:none;"><img id="album_public_img_'.$key.'" class="notfengmian" src="'.$coverPath.'" width="'.$photo_size['w'].'" height="'.$photo_size['h'].'" /></span><span style="display:none;"><img id="album_private_img_'.$key.'" class="notfengmian" src="../content/plugins/kl_album/images/only_me.jpg" /></span><span><img id="album_protect_img_'.$key.'" class="notfengmian" src="'.$coverPath.'" width="'.$photo_size['w'].'" height="'.$photo_size['h'].'" /></span>';
				break;
		}
		echo '
<li>
