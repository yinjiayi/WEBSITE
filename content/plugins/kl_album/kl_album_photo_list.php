...
?>
<style type="text/css">
#gallery {padding: 10px;text-align:left; font-size:12px;height:100%;overflow:auto;}
#gallery ul { list-style: none;margin:0px}
#gallery ul li { display: inline; width:350px; height:100%; float:left; margin: 5px 5px 5px; border:0px solid #ccc;}
...
<table height="100%" width="100%" border="0" style="background:#FFF;border:1px solid #CCC;">
  <tr>
	...
	<td width="110" height="110" rowspan="2" align="center"><a href="<?php echo str_replace('thum-', '', $val['filename']); ?>" target="_blank"><img class="<?php echo $val['id'] == $head ? 'fengmian' : 'notfengmian'; ?>" id="img_<?php echo $val['id']; ?>" src="<?php echo $val['filename']; ?>" width="100px" height="100px" /></a></td>
	<td vlign="top">
