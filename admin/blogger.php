...
if ($action == '') {
	...
	if ($photo) {
		...
		$icon = "<div class=\"easypiechart\" data-percent=\"75\" data-line-width=\"6\" data-bar-color=\"#fff\" data-track-Color=\"#2796de\" data-scale-Color=\"false\" data-size=\"140\" data-line-cap=\"butt\" data-animate=\"1000\"><div class=\"thumb-lg avatar\"><img src=\"{$photo}\" width=\"{$imgsize['w']}\" height=\"{$imgsize['h']}\" class=\"dker\"></div></div><div class=\"h4 m-t m-b-xs font-bold text-lt\"></div><small class=\"text-muted m-b\"><a href=\"javascript: em_confirm(0, 'avatar', '$token');\">删除头像</a></small>";
	} else{
		$icon = "<div class=\"easypiechart\" data-percent=\"75\" data-line-width=\"6\" data-bar-color=\"#fff\" data-track-Color=\"#2796de\" data-scale-Color=\"false\" data-size=\"140\" data-line-cap=\"butt\" data-animate=\"1000\"><div class=\"thumb-lg avatar\"><img src=\"./views/images/avatar.jpg\" class=\"dker\"></div></div><div class=\"h4 m-t m-b-xs font-bold text-lt\"></div><small class=\"text-muted m-b\"></small>";
	}
