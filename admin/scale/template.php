				...
				<section class="panel panel-default">
					<header class="panel-heading font-bold">
						<ul class="nav nav-tabs">
							<li class="active"><a href="./template.php">模板管理</a></li>
							<li><a href="template.php?action=install">安装模板</a></li>
						</ul>
					</header>
				</section>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 tpls">
					<section class="panel b-a add">
						<div class="panel-heading"><a href="./template.php?action=install"><i class="fa fa-plus-circle" style="font-size:10em;"></i></a></div>
					</section>
				</div>
			</div>
		</div>
